...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/nailpolishes', [NailpolishController::class, 'index'])->name('nailpolishes.index');//show a list of nailpolishes
   ...
   // Route::get('/nailpolishes', [NailpolishController::class, 'store'])->name('nailpolishes.store'); //handle creating a new nailpolish
   Route::patch('/nailpolishes', [NailpolishController::class, 'update'])->name('nailpolishes.update');//update an exising new nailpolish
   Route::get('/nailpolishes/edit', [NailpolishController::class, 'edit'])->name('nailpolishes.edit');//display edit form for existing nail polish
